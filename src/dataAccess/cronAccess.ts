import { Account, Interval, Periodic, TransactionReason } from '@prisma/client';
...
const processPeriodicTransactions = async (minDate: Date, maxDate: Date) => {
  await db.$transaction(async (prisma) => {
    ...
    console.log('A1. periodics ', periodics);
    ...
    console.log('A2. accounts ', accounts);
    console.log('A PROCESSING PERIODICS - - - >');
    for (const periodic of periodics) {
